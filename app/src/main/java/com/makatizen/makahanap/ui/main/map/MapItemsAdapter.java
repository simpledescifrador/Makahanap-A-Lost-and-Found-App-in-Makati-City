...
public class MapItemsAdapter extends BaseRecyclerViewAdapter<MapItemsAdapter.ViewHolder, FeedItem> {

    private Context mContext;

    @Inject
    public MapItemsAdapter(Context context) {
        mContext = context;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.classic_item, viewGroup, false));
    }
