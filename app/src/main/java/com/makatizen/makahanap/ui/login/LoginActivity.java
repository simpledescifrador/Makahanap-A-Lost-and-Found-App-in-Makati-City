...
public class LoginActivity extends BaseActivity implements LoginMvpView {
    ...
    @OnClick({R.id.login_btn_login, R.id.login_tv_register, R.id.login_iv_password_toggle, R.id.login_tv_forgot_password})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.login_tv_forgot_password:
                Intent fIntent = new Intent(this, ForgotPasswordActivity.class);
                fIntent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivityForResult(fIntent, RequestCodes.FORGOT_PASSWORD);
                break;
        }
    }
